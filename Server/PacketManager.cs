...
namespace Server
{
    public class PacketManager
    {
        ...
        private void RegisterHandler() // 핸들러 구독
        {
            ...
            packetFactories.Add((ushort)PacketID.C_SelectPacket, PacketUtility.CreatePacket<C_SelectPacket>);
            packetHandlers.Add((ushort)PacketID.C_SelectPacket, PacketHandler.C_SelectPacket);
        }
